...
class AuthTokenControllerTest {
  ...
  void reissueAccessToken_setsBothCookiesOnSuccess() {
    ...
    when(tokenReissueService.reissue("old-refresh", SessionType.WEBVIEW))
  ...
  void reissueAccessToken_clearsCookiesWhenRefreshMissing() {
    ...
    verify(tokenReissueService, never())
        .reissue(org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.any());
  }
}
