...
CREATE INDEX idx_notification_endpoint_member_active ON notification_endpoint (member_id, is_active);
CREATE UNIQUE INDEX uq_notification_endpoint_member_url ON notification_endpoint (member_id, endpoint_url);
