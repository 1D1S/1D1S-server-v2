...
public enum ErrorCode {
  ...
  CATEGORY_EMPTY(
      HttpStatus.BAD_REQUEST, "USER-001", "At least one interest category must be selected"),
  CATEGORY_TOO_MANY(
      HttpStatus.BAD_REQUEST, "USER-002", "Up to 3 interest categories can be selected"),
  MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, "USER-003", "Member not found"),
  INVALID_NICKNAME_FORMAT(
      HttpStatus.BAD_REQUEST,
      "USER-004",
      "Nickname must be Korean or English, max 8 chars, no special characters");
