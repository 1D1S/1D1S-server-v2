...
public class FriendController {
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"message\": \"친구 신청을 보냈습니다.\" }")
            })),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
            description = "회원을 찾을 수 없음",
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"code\": \"USER-003\", \"message\": \"회원을 찾을 수 없습니다.\" }")
            }))
    })
    @PostMapping("/request")
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"message\": \"친구 신청을 취소했습니다.\" }")
            }))
    })
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"message\": \"친구 신청을 수락했습니다.\" }")
            }))
    })
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"message\": \"친구 신청을 거절했습니다.\" }")
            }))
    })
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"data\": [{ \"memberId\": 2, \"nickname\": \"홍길동\", \"profileUrl\": \"https://...\" }] }")
            }))
    })
    @GetMapping
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"data\": [{ \"requestId\": 1, \"fromMemberId\": 2, \"fromMemberNickname\": \"홍길동\", ... }] }")
            }))
    })
    @GetMapping("/requests/received")
    public ApiResponse<List<FriendRequestResponseDto>> getReceivedFriendRequests() {
        return ApiResponse.success(Message.GET_FRIEND_REQUESTS, friendService.getReceivedFriendRequests());
    }
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"data\": [{ \"requestId\": 1, \"toMemberId\": 2, \"toMemberNickname\": \"홍길동\", ... }] }")
            }))
    })
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"message\": \"친구를 삭제했습니다.\" }")
            }))
    })
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            description = "차단 성공",
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"message\": \"회원을 차단했습니다.\" }")
            }))
    })
    @PostMapping("/block")
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"message\": \"차단을 해제했습니다.\" }")
            }))
    })
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"data\": [{ \"memberId\": 2, \"nickname\": \"홍길동\", ... }] }")
            }))
    })
    @GetMapping("/block")
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(value = "{ \"data\": { \"memberId\": 2, \"relationStatus\": \"FRIEND\" } }")
            }))
    })
    @GetMapping("/relation/{memberId}")
    public ApiResponse<MemberRelationResponseDto> getMemberRelation(@PathVariable Long memberId) {
        return ApiResponse.success(Message.GET_MEMBER_RELATION, friendService.getMemberRelation(memberId));
    }
}
