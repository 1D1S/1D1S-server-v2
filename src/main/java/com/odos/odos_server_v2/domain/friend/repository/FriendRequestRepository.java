...
public interface FriendRequestRepository extends JpaRepository<FriendRequest, Long> {
  ...
  List<FriendRequest> findByToMemberAndStatus(
      @Param("member") Member member, @Param("status") FriendRequestStatus status);
  ...
  boolean existsByFromMemberAndToMemberAndStatus(
      Member fromMember, Member toMember, FriendRequestStatus status);
}
